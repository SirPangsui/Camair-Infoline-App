...
class BottomNavigationDotBar extends StatefulWidget {
  ...
  const BottomNavigationDotBar(
      {required this.items, required this.activeColor, required this.color, required Key key})
      : super(key: key);
...
class _BottomNavigationDotBarState extends State<BottomNavigationDotBar> {
  ...
  _afterLayout(_) {
    ...
    if(_keyBottomBar.currentContext!=null){
        ...
        child: Material(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: context.read<ThemeBloc>().darkTheme == true ? Colors.black:Colors.white,
                borderRadius: BorderRadius.only(
