...
import 'package:cmer_infoline/pages/edit_profile.dart';
import 'package:cmer_infoline/pages/welcome.dart';
import 'package:cmer_infoline/services/app_service.dart';
import 'package:cmer_infoline/widgets/language.dart';
...
class _ProfilePageState extends State<ProfilePage> with AutomaticKeepAliveClientMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('profile',style: TextStyle(color: Config().appColorGreen),).tr(),
        centerTitle: false,
        actions: [
      ...
      children: [
        ...
        ListTile(
            ...
            leading: Container(
              height: 30,
              width: 30,
              child: Icon(Feather.mail, size: 20),
            ),
          ),
          Divider(height: 3,),
          ...
          ListTile(
           ...
           /*   decoration: BoxDecoration(
              ...
              child: Icon(Feather.edit_3, size: 20),
            ),
            trailing: Icon(Feather.chevron_right, size: 20,),
          ...
          ListTile(
            ...
            leading: Container(
             ...
             /* decoration: BoxDecoration(
              ...
              child: Icon(Feather.log_out, size: 20, color: Colors.red),
            ),
            trailing: Icon(Feather.chevron_right, size: 20,),
