...
import 'package:cmer_infoline/blocs/videos_bloc.dart';
import 'package:cmer_infoline/cards/card4.dart';
import 'package:cmer_infoline/cards/card5.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'video articles', style: TextStyle(color: Config().appColorGreen),
