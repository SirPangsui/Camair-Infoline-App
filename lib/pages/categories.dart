...
import 'package:cmer_infoline/blocs/categories_bloc.dart';
import 'package:cmer_infoline/models/category.dart';
import 'package:cmer_infoline/pages/category_based_articles.dart';
import 'package:cmer_infoline/utils/cached_image_with_dark.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'categories',
            style: TextStyle(color: Config().appColorGreen),
          ).tr(),
          elevation: 0,
          actions: <Widget>[
            IconButton(
    ...
    return InkWell(
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Text(d.displayCategoryName!, style: TextStyle(
                  fontSize: 20,
                  color: Colors.white,
      ...
      onTap: (){
        nextScreen(context, CategoryBasedArticles(
          dataCategory: d.dataCategoryName,
          displayCategory: d.displayCategoryName,
