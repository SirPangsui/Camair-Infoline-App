...
import 'package:cmer_infoline/pages/notifications.dart';
import 'package:cmer_infoline/pages/search.dart';
import 'package:cmer_infoline/utils/app_name.dart';
import 'package:cmer_infoline/utils/next_screen.dart';
import 'package:cmer_infoline/widgets/drawer.dart';
import 'package:cmer_infoline/widgets/tab_medium.dart';
...
class _ExploreState extends State<Explore> with  AutomaticKeepAliveClientMixin, TickerProviderStateMixin {
  ...
  List<Tab> _tabs = [
    ...
    Tab(
      text: Config().initialCategoriesLabel[0],
    ),
    Tab(
      text: Config().initialCategoriesLabel[1],
    ),
    Tab(
      text: Config().initialCategoriesLabel[2],
    ),
    Tab(
      text: Config().initialCategoriesLabel[3],
    ),
  ];
