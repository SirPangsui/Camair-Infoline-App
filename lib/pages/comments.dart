...
class _CommentsPageState extends State<CommentsPage> {
  ...
  Future handleReport(Comment d) async {
    ...
    if (sb.isSignedIn == true) {
      await context.read<CommentsBloc>().reportComment(widget.timestamp, d.uid, d.comment, d.timestamp);
      Navigator.pop(context);
              ...
              child: _hasData == false
                  ? Column(
                      children: [
                        Spacer(),
                        EmptyPageImage(
                           icon: "assets/images/no_reviews.jpeg",
  ...
  Widget _commentCardOld(Comment d) {
    return InkWell(
      child: Container(
          child: Row(
        children: <Widget>[
