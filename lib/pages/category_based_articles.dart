...
import 'package:cmer_infoline/cards/sliver_card.dart';
import 'package:cmer_infoline/cards/sliver_card1.dart';
...
class CategoryBasedArticles extends StatefulWidget {
  ...
  final String tag;
  CategoryBasedArticles({Key? key, required this.displayCategory, required this.dataCategory,required this.categoryImage, required this.tag}) : super(key: key);
  ...
  Future<Null> _getData() async {
    ...
    if (_lastVisible == null)
      data = await firestore
          ...
          .where('category', isEqualTo: widget.dataCategory)
